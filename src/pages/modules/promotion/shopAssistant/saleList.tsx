    ...
    <div className={classes.root}>
      ...
      <div className={classes.box} style={{ marginTop: '-2.5%' }}>
        <div className={classes.navtop}>
          ...
          <span style={{ display: 'inline-block', width: '34%' }}>购买时间</span>
          <span style={{ display: 'inline-block', width: '20%' }}>消费金额</span>
        </div>
      </div>
      <div style={{ marginTop: '0.5%', background: '#fff' }}>
        <div className={classes.navlist}>
          ...
          <span style={{ width: '34%', textAlign: 'center' }}>2019-07-12 11：25</span>
          <span style={{ width: '20%', textAlign: 'center' }}>100</span>
        </div>
      </div>
